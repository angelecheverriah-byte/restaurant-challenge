  ...
  return (
    <div className="min-h-screen bg-[#0f172a] p-4 md:p-8 font-sans text-slate-300">
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* 1. MONITOR DE ÓRDENES (Ahora primero en móvil usando order-first o simplemente colocándolo arriba) */}
        ...
        {/* 2. COLUMNA DE INVENTARIO Y LOGS (Aparecerá después del Monitor en móvil) */}
          ...
          <section className="bg-slate-800/40 p-6 rounded-3xl border border-slate-700/50 shadow-xl">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {inventory.map((item) => (
                <div
                  key={item.name}
                  className="p-3 bg-slate-900/50 border border-slate-700/30 rounded-2xl flex justify-between items-center hover:border-emerald-500/30"
                >
            ...
            {/* LOG DE SUMINISTROS (Historial de Compras) */}
